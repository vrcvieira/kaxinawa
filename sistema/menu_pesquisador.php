 ...
 /*
  ...
  <body>
    <div align="left" width="450">
      ...
      Editais <br />
      <div id="f_editais" style="display:none"> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href="javascript:;" onclick="carrega('editais_disponiveis.php')" >Editais Disponiveis</a><br />
      ...
      Projetos <br />
      <div id="f_projetos" style="display:none" > &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href="javascript:;" onclick="carrega('criar_projeto.php')"  >Criar Projeto</a> <br />
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href="javascript:;" onclick="carrega('modificar_projeto.php')"  >Modificar Projeto</a><br />
